...
S3_OUTPUT_LOCATION = "s3://cloudassignmentsudeepta/enriched/" # Your Athena results bucket
# -------------------------------------------
...
queries_to_run = [
    {
        ...
        "query": """
            ...
            FROM "AwsDataCatalog"."orders_db"."processed"
            GROUP BY customer
    ...
    },
    {
        ...
        "query": """
            ...
            FROM "AwsDataCatalog"."orders_db"."processed"
            WHERE date_trunc('month', CAST(OrderDate AS DATE)) = DATE '2025-02-01'
